...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2024 at 11:08 AM
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='pet infomations';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='student infomations';
...
('110', 'uraiwan na', 'inyaem', 'pathumthani', 898944631),
('111', 'nanfa', 'sontornjerawat', 'bangkok', 928132297),
...
CREATE TABLE `studentpet` (
  ...
  `sid` varchar(3) NOT NULL,
  `pid` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='studentpet infomations';
