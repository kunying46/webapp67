                ...
                <?php // show data by fetch from database
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo"<tr><td>".$row["mbID"]."</td>"."<td>".$row["mbname"]." ".$row["mblastname"]."</td>"."<td>".$row["address"]."</td>"."<td>".$row["telephone"]."</td>"."<td>"."<a href='editmember.php?mbID=".$row["mbID"]."'><button> Edit </button></a>"."</td>";
                            echo "</tr>"; 
